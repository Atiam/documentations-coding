...
const person = {
  ...
  saySomething: function() {
    console.log(`test 1: ${this.name} is thinking...`);
    setTimeout(function() {
      console.log(`test 02: ${this.name}!`);
    }, 100);
  }
};
...
const person2 = {
  name: "Hodor",
  saySomething: function() {
    console.log(`test 03: ${this.name} is thinking...`);
    setTimeout(() => console.log(`test04:${this.name}!`), 100);
  }
};
